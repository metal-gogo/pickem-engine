# 002 Product Direction Friends Family First
...
The project starts as a passion project for the `2026 FIFA World Cup`. It needs to stay lean and practical, but it should not paint itself into a corner if the product later becomes worth opening to a wider audience.
