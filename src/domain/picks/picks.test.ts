...
const matches: Match[] = [
  {
    ...
    venue: "Mexico City",
    homeTeam: { id: "mex", name: "Mexico", shortName: "Mexico", code: "MEX", accent: "#00853f" },
    awayTeam: { id: "jpn", name: "Japan", shortName: "Japan", code: "JPN", accent: "#1f4fff" },
  },
  {
    id: "match-2",
    sequence: 2,
    ...
    venue: "Los Angeles",
    homeTeam: { id: "usa", name: "United States", shortName: "USA", code: "USA", accent: "#d22630" },
    awayTeam: { id: "gha", name: "Ghana", shortName: "Ghana", code: "GHA", accent: "#fcd116" },
  },
];
