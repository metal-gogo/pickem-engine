...
export function StandingsRow({ entry }: StandingsRowProps) {
  const movementTone =
    entry.trend === "up" ? "success" : entry.trend === "down" ? "warning" : "neutral";
  ...
  return (
    ...
    >
      <div className="font-display text-[1.4rem] font-black uppercase tracking-[-0.05em] text-app-ink">
        {entry.rank}
      </div>
      ...
      <div className="grid gap-0.5">
        <span className="font-display text-[1rem] font-black uppercase tracking-[-0.03em] text-app-ink">
          {entry.name}
        </span>
      ...
      <div className="grid justify-items-start sm:col-start-3 lg:justify-items-end">
        <span className="font-display text-[1.4rem] font-black uppercase tracking-[-0.05em] text-app-ink">
          {entry.points}
        </span>
