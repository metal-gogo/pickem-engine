/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-file=worker-configuration.env` (hash: 1e8c4909ce91f10c35b06a429616d031)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		WORKOS_LOGOUT_REDIRECT_URI: string;
		SENTRY_DSN: string;
		SENTRY_ENVIRONMENT: string;
		SENTRY_RELEASE: string;
		STITCH_GOOGLE_API_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_BASE_URL" | "APP_SESSION_SECRET" | "DATABASE_URL" | "DIRECT_URL" | "WORKOS_CLIENT_ID" | "WORKOS_API_KEY" | "WORKOS_COOKIE_PASSWORD" | "WORKOS_REDIRECT_URI" | "WORKOS_LOGOUT_REDIRECT_URI" | "SENTRY_DSN" | "SENTRY_ENVIRONMENT" | "SENTRY_RELEASE" | "STITCH_GOOGLE_API_KEY">> {}
}
